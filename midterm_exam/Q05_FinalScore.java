public class Q05_FinalScore {
    ...
    public static double calculateFinalScore(int examScore, int assignmentScore, int bonus) {
        if (examScore < 0 || examScore > 100 || assignmentScore < 0 || assignmentScore > 100 || bonus < 0 || bonus > 10) return -1.0;
        return Math.min(100.0, examScore * 0.4 + assignmentScore * 0.6 + bonus);
    }
}
