public class Q12_BookingReport {
    ...
    public static int countConfirmed(Q12_Booking[] bookings) {
        ...
        int count = 0; for (Q12_Booking booking : bookings) if (booking != null && booking.isConfirmed()) count++; return count;
    }
    public static double calculateConfirmedRevenue(Q12_Booking[] bookings) {
        if (bookings == null) return 0.0;
        double total = 0; for (Q12_Booking booking : bookings) if (booking != null && booking.isConfirmed()) total += booking.getTotalPrice(); return total;
    }
    public static Q12_Booking findById(Q12_Booking[] bookings, String id) {
        if (bookings == null || id == null) return null;
        for (Q12_Booking booking : bookings) if (booking != null && booking.getId() != null && booking.getId().equalsIgnoreCase(id)) return booking;
        return null;
    }
    public static Q12_Booking findLargestConfirmed(Q12_Booking[] bookings) {
        if (bookings == null) return null;
        Q12_Booking largest = null;
        for (Q12_Booking booking : bookings) if (booking != null && booking.isConfirmed() && (largest == null || booking.getTotalPrice() > largest.getTotalPrice())) largest = booking;
        return largest;
    }
}
